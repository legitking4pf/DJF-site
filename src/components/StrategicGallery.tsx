...
export default function StrategicGallery() {
  const images = [
    ...
    { id: 5, src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/honduras-bancas_11242238_20250701164910.jpg",
    ...
    { id: 8, src: "https://hv4w1qmfjrk8zaij.public.blob.vercel-storage.com/images.jpeg", 
      title: "Sustainability", span: "lg:col-span-1 lg:row-span-1" },
  ];
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-10">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-sm md:text-lg max-w-2xl mx-auto leading-relaxed font-light text-ash">
            A visual manifestation of the GFA Strategic Vision — mapping digital integration, investment partnerships, and sustainable design.
          </p>
        </div>
        ...
        >
          {images.map((img, index) => { // Renamed from Image to img
            ...
            return (
              ...
              >
                <div className="w-[240px] h-[340px] relative rounded-lg overflow-hidden shadow-2xl border border-obsidian/10">
                  <NextImage 
                    src={img.src} 
                    alt={img.title} 
                    fill 
