        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 mb-24 items-end">
          <div className="lg:col-span-8">
            ...
            <motion.h2 
              ...
              className="text-3xl md:text-6xl font-serif italic tracking-tighter leading-[1:1]"
            >
              Strategic <br /> <span className="not-italic text-obsidian uppercase">Sovereignty</span>
            </motion.h2>
          </div>
